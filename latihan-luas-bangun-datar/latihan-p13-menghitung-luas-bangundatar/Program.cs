            ...
            do
            {
                ...
                switch (luasTanah)
                {
                    case 1:
                        ...
                        Console.WriteLine($"Luas tanah lingkaran = {hasil:N1} cm2");
                        break;
                    case 2:
                        nama = "segitiga";
                        Console.WriteLine(nama);
                        ...
                        Console.WriteLine($"Luas dari tanah segitiga : {hasil:N1} cm2");
                        break;
                    case 3:
                        nama = "Trapesium";
                        Console.WriteLine(nama);
                        ...
                        Console.WriteLine($"Luas dari tanah trapesium : {hasil:N1} cm2");
                        break;
                    case 4:
                        ...
                        Console.WriteLine($"Luas tanah persegi panjang : {hasil:N1} cm2");
                        break;
                    case 5:
                        nama = "jajar genjang";
                        Console.WriteLine(nama);
                        ...
                        Console.WriteLine($"Luas tanah jajar genjang : {hasil:N1} cm2");
                        break;
                }
